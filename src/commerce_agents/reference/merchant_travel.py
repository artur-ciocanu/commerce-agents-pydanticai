...
from .fixtures import find_by_id, load_json
...
from .travel import DATA_DIR, MockTravel, load_occupancy
...
class StayPricingContext(PricingContext):
    ...
    active_rate_overrides: list[dict[str, Any]] = Field(default_factory=list)
